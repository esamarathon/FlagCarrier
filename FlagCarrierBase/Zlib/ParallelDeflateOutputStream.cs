...
namespace FlagCarrierBase.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        FlagCarrierBase.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="FlagCarrierBase.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="FlagCarrierBase.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private FlagCarrierBase.Crc.CRC32   _runningCrc;
        ...
        private readonly FlagCarrierBase.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="FlagCarrierBase.Zlib.DeflateStream"/>,
        ...
        ///   cref="FlagCarrierBase.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new FlagCarrierBase.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="FlagCarrierBase.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                FlagCarrierBase.Crc.CRC32 crc = new FlagCarrierBase.Crc.CRC32();
